...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__tasks_tasks_list_tasks_list_component__ = __webpack_require__("../../../../../src/app/tasks/tasks-list/tasks-list.component.ts");
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_4__tasks_tasks_list_tasks_list_component__["a" /* TasksListComponent */],
        ...
        providers: [
            __WEBPACK_IMPORTED_MODULE_6__tasks_task_service__["a" /* TaskService */]
        ],
...
var Task = (function () {
    function Task(description, completed, dueDate) {
...
var TaskService = (function () {
    function TaskService(http) {
        this.http = http;
        this.addTaskEvent = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["c" /* EventEmitter */]();
    }
    ...
    TaskService.prototype.save = function (task, checked) {
        ...
        return this.http.post("/api/tasks", task).map(function (response) { return response.json(); });
    };
    return TaskService;
}());
...
var TasksAddComponent = (function () {
    ...
    TasksAddComponent.prototype.onTaskAdded = function (event) {
        var taskDescription = event.target.value;
        // clear the input
        this.taskName = null;
        // generate add task event
        this.taskService.addTaskEvent.emit(new __WEBPACK_IMPORTED_MODULE_2__task_model__["a" /* Task */](taskDescription, false, "10/10/2017"));
    };
...
var TasksListComponent = (function () {
    ...
    TasksListComponent.prototype.ngOnInit = function () {
        ...
        this.taskService.addTaskEvent.subscribe(function (newTask) {
            _this.tasks.push(newTask);
            _this.taskService.save(newTask, false).subscribe();
        });
    };
